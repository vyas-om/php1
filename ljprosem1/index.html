...
<body>
  ...
  <div className='container'>
    ...
    <img src="img/3.jpg" class="card-img-top f1" alt="..."/>
  <div class="card-body">
  ...
  <div class="card col-4" style="width: 18rem;">
    <img src="img/2.jpg" class="card-img-top f2" alt="..."/>
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  ...
  <div class="card col-4" style="width: 18rem;">
    <img src="img/3.jpg" class="card-img-top f3" alt="..."/>
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  ...
  <div class="card col-4" style="width: 18rem;">
    <img src="img/2.jpg" class="card-img-top f4" alt="..."/>
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Go somewhere</a>
